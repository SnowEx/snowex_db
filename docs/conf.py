#!/usr/bin/env python
#
# snowex_db documentation build configuration file, created by
...
version = snowex_db.__version__
# The full version, including alpha/beta/rc tags.
release = snowex_db.__version__
...
htmlhelp_basename = 'snowex_dbdoc'
