...
from snowex_db.projection import (
    add_geom, reproject_point_in_dict, reproject_raster_by_epsg
)


@pytest.mark.parametrize(
    'info, utm_zone, expected', [
        # Test we add UTM info when its not provided
        (
                {'latitude': 39.039, 'longitude': -108.003}, None,
                {
                    'easting': 759397.644, 'northing': 4325379.675,
                    'utm_zone': 12,
                },
        ),
        ...
        (
                {
                    'latitude': 39.008078, 'longitude': -108.184794,
                    'utm_wgs84_easting': 743766.4795,
                    'utm_wgs84_northing': 4321444.155,
                }, None,
        ...
        (
                ...
                {
                    'northing': 4332280.1658, 'easting': 771338.607,
                    "utm_zone": 12,
                },
        ),
        ...
        (
                {
                    "utm_zone": "10N", "easting": "757215",
                    "northing": "4288778",
                    "latitude": "38.71025", "longitude": "",
                }, None,
                {
                    "utm_zone": 10, "easting": 757215.0, "northing": 4288778.0,
                    "latitude": 38.71025, "longitude": -120.041884,
                    'epsg': 26910,
                },
        ),
        ...
        (
                {
                    "utm_zone": "12N", "latitude": "38.71033",
                    "longitude": "-120.04187",
                }, None,
                {
                    "utm_zone": 10, "latitude": 38.71025,
                    "longitude": -120.041884,
                    'epsg': 26910,
                },
        ),
        ...
        (
                {
                    'easting': 465058.37445, 'northing': 7193480.256156,
                    'utm_zone': 6,
                },
                None, {'epsg': 26906},
        ),
...
class TestReprojectRasterByEPSG():
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                    'uavsar_latlon.amp1.real.tif',
                    26912,
                    (748446., 4325651., 751909., 4328702.),
            ),
        ]
    )
    def test_reproject(self, input_f, epsg, bounds):
        ...
        assert CRS.from_epsg(epsg) == dcrs

        # Assert bounds
        for i, v in enumerate(bounds):
            assert_almost_equal(v, dbounds[i], 0)
